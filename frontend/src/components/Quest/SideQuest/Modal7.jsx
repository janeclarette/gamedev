      ...
      <Fade in={showModal}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ color: '#000', mb: 2, fontFamily: "'Fraunces', serif", fontSize: "20px" }}>
            "If I buy a big bag of rice and some vegetables, I can cook multiple meals… but instant noodles are cheaper and easier. Should I go for nutrition or convenience?"
          </Typography>
